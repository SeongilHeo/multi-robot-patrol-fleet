...
#include "mini_dogu_interfaces/msg/robot_incident.hpp"

#include "mini_dogu_interfaces/srv/assign_mission.hpp"
#include "mini_dogu_interfaces/srv/queue_mission.hpp"
#include "mini_dogu_interfaces/srv/report_incident.hpp"
...
public:
  ...
  using StartMission =
    mini_dogu_interfaces::srv::StartMission;

  using QueueMission =
    mini_dogu_interfaces::srv::QueueMission;

  using ReportIncident =
    mini_dogu_interfaces::srv::ReportIncident;

  using RobotIncident =
    mini_dogu_interfaces::msg::RobotIncident;
    ...
    : Node("fleet_manager")
  {
    ...
    mission_store_ =
      std::make_unique<mini_dogu_fleet::MissionStore>(
      mission_db_path_);
...
private:
  ...
  std::unique_ptr<mini_dogu_fleet::MissionStore> mission_store_;
