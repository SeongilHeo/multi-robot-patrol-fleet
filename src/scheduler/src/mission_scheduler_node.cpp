...
#include "interfaces/msg/mission_queue_state.hpp"
...
#include "interfaces/srv/cancel_mission.hpp"
...
public:
  using FleetState =
    interfaces::msg::FleetState;

  using MissionQueueState =
    interfaces::msg::MissionQueueState;
